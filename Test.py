...
#create training input vectors


# x_train_full = [train_data['Sex'], train_data['Age'], train_data['Pclass'], train_data['SibSp'], train_data['Parch'],
#            train_data['Fare'], train_data['Cabin']]

x_train_full = train_data[['Sex','Age','Pclass','SibSp','Parch','Fare','Cabin']]

# x_train_full = np.array(x_train_full).T.tolist()
...
# np.savetxt("out.csv",task_data['Survived'],delimiter=",")
